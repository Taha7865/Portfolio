    ...
    <body class="flex flex-col min-h screen relative flex flex-col items-stretch justify-center min-h-screen">
              ...
              <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 ">
                ...
                <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg shadow-2xl bg-white mx-6 lg:mx-0 opacity-90 -translate-y-10">
                  ...
                  <div class="p-4 md:p-12 text-center lg:text-left">
                    ...
                    <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg class="hidden md:block h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"></path></svg>SWE @ UnitedHealth Group</p>
                    ...
                    <p class="font-medium m-2 text-blue-700 pt-5 font-bold">Current Associate Software Engineer at UnitedHealth Group. Enjoy sports, hanging out, and trying new things. </p>
            ...
            <section class="container mx-auto px-8">
              ...
              <FadeInOnScroll>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 font-thin">
                  ...
                  <div class="bg-gradient-to-r from-cyan-600 to-blue-500 p-8 rounded-lg text-center justify-center flex flex-col items-center transition-transform duration-300 transform hover:scale-105 hover:shadow-xl">
                  ...
                  <div class="bg-gradient-to-r from-cyan-600 to-blue-500 p-8 rounded-lg text-center justify-center flex flex-col items-center transition-transform duration-300 transform hover:scale-105 hover:shadow-xl">
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="100" height="100"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 9.5V15.5M12 15.5L10 13.5M12 15.5L14 13.5M8.4 19C5.41766 19 3 16.6044 3 13.6493C3 11.2001 4.8 8.9375 7.5 8.5C8.34694 6.48637 10.3514 5 12.6893 5C15.684 5 18.1317 7.32251 18.3 10.25C19.8893 10.9449 21 12.6503 21 14.4969C21 16.9839 18.9853 19 16.5 19L8.4 19Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>                    <h3 class="text-white text-xl font-semibold mt-4">Infrastructure/Devops</h3>
                    <p class="pt-2 font-normal font-semibold">I have leveraged Amazon Web Service and worked with Cloud like Infrastructure. I am  familiar with essential AWS services such as Amazon EC2 for virtual server environments, Amazon S3 for scalable storage, and AWS Lambda for serverless computing. I have deployed many resources using Terraform, Infrastructure as a Service.</p>
                  </div>
                </div>
              </FadeInOnScroll>
              </section>
                ...
                <body>
                  <div class="md:container mx-auto py-10 px-4 flex flex-col justify-center items-center">
                    ...
                    <div class='flex flex-col md:flex-row items-center justify-between space-x-0 md:space-x-4 space-y-4 md:space-y-0'>
                        ...
                        <div class="text-left">
                          <h2 class="text-xl font-semibold text-white">Current</h2>
                          <h3 class="text-2xl text-yellow-700 font-bold">Associate Software Engineer</h3>
                          <h4 class="text-xl font-semibold text-white">Minneapolis, Minnesota</h4>
                          <p class="bg-gradient-to-r from-cyan-600 to-blue-500 text-transparent bg-clip-text font-extrabold overflow-wrap w-80">As a software engineer, I am currently working among a team of developers working to help participants manage and potentially improve their condition through a combination of real-time glucose monitoring, lifestyle adjustments, and personalized one-on-one coaching. </p>
                        </div>
                      </div>
                    </FadeInOnScroll>
                    ...
                    <FadeInOnScroll>
                      ...
                      <div class='flex flex-col md:flex-row items-center justify-between space-x-0 md:space-x-4 space-y-4 md:space-y-0'>
                        ...
                        <div class="text-left">
                          ...
                          <h4 class="text-xl font-semibold text-white">Dallas, TX</h4>
                          <p class="bg-gradient-to-r from-cyan-600 to-blue-500 text-transparent bg-clip-text font-extrabold overflow-wrap w-80">As a Data Engineer Intern at Publishing Concepts Inc., I managed and archived hundreds of databases containing sensitive consumer information. I generated reports detailing database architecture and ensured data integrity. I executed stored procedures in SQL to responsibly update thousands of client materials and collaborated with developers to debug network issues and system errors.</p>
                        </div>
                      </div>
                     </FadeInOnScroll>
      ...
      <footer class=" text-white pb-2 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black">
        ...
        <div class="mt-2 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center space-x-4 justify-center">
          <span class="gap-8 text-white flex items-start">© 2024 Taha Ahmed All Rights Reserved.</span>
